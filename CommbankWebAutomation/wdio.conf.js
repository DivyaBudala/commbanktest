...
const stepTimout = debug ? 24 * 60 * 60 * 1000 : 700000;
...
exports.config = {
    ...
    //
    // Default timeout in milliseconds for requestss
    ...
    cucumberOpts: {
        ...
        require: ['./src/step-definitions/*.steps.ts'], // <string[]> (file/dir) require files before executing features
    },
